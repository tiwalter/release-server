...
namespace ReleaseServer.WebApi.Controllers
{
    ...
    public class ReleaseArtifactController : ControllerBase
    {
        ...
        private static int CompareByVersion(ProductInformationModel x, ProductInformationModel y) {
        ...
        public async Task<ActionResult<ProductInformationListResponseModel>> GetProduct(
            ...
            )
        {
            ...
            productInfos = productInfos
                .Where((ProductInformationModel release) => {
                    var match = true;
                    if (architectures.Count > 0) {
                        match &= architectures.Contains(release.HwArchitecture);
                    }
            ...
            return productInfos.ToProductInfoListResponse(limit, offset);
        }
